...
<div className="border-2 border-gray-200 dark:border-gray-800 rounded-lg p-6 my-4">
  <ul className="space-y-2">
    <li>why did i make this roadmap? read <a href="https://blog.hiteshbandhu.xyz/blog/genai-hustle-announcement" className="text-blue-500 hover:text-blue-600 dark:text-blue-400 dark:hover:text-blue-300">this</a></li>
    <li>need any ai services built? <a href="https://www.hiteshbandhu.xyz/" className="text-blue-500 hover:text-blue-600 dark:text-blue-400 dark:hover:text-blue-300">contact me</a></li>
  </ul>
</div>
...
<div className="border-l-4 border-yellow-400 p-4 my-4">
  <p>
    <strong>Note:</strong> This roadmap is actively being updated with new resources and learnings each day. Check back regularly for the latest additions and refinements.
  </p>
</div>
